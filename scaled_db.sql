...
(4, '2025_03_22_013540_create_categories_table', 1),
(5, '2025_03_22_013558_create_products_table', 1),
...
CREATE TABLE `orders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `status` enum('created','confirmed') NOT NULL,
...
--
-- Estructura de tabla para la tabla `wish_items`
--
...
--
-- Volcado de datos para la tabla `wish_items`
--
...
--
-- Indices de la tabla `wish_items`
--
...
--
-- Filtros para la tabla `wish_items`
--
ALTER TABLE `wish_items`
  ADD CONSTRAINT `wish_items_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `wish_items_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
